  ...
  return (
    <section id="journal-section" className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {activeArticle && typeof document !== 'undefined' && createPortal(
        ...
        >
          <div
            className="bg-[#FDF8F3] rounded-3xl max-w-2xl w-full max-h-[88vh] overflow-y-auto no-scrollbar article-modal border border-[#1D3D33]/10 shadow-2xl p-6 sm:p-8 relative"
