...
# Namespaced separately from backend/data and backend/models, which belong
# to the crowd-prediction (LightGBM) side of this project -- keeping the two
# ML layers' artifacts on disk fully independent of one another.
DATA_DIR = os.path.join(BASE_DIR, "weather_ml_data")
MODELS_DIR = os.path.join(BASE_DIR, "weather_ml_models")
